...
offset = 1 # offset value for k-vectors
...
ax.plot(k_points[:-1], Delta_E, 'o', color='royalblue', markersize=8)
ax.plot(k, f_inter(k), '-', color='royalblue', linewidth=2)
