...
def write_CO2_coor(file, 
  ...
  CO2_height = OT[2] + height_from_surf
...
try:
  previous_dist = height_from_surf - 0.5
  relaxed_coor_file_name = f'dist_at_{previous_dist}'
...
with open(f'dist_at_{height_from_surf}-coor.dat', 'w') as file:
